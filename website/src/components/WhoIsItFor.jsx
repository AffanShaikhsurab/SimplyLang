...
const WhoIsItFor = () => {
  ...
  return (
    <section className="relative py-20 overflow-hidden">
      <div class="absolute top-0 -z-10 h-full w-full bg-white dark:bg-black"><div class="absolute bottom-auto left-auto right-0 top-0 h-[500px] w-[500px] -translate-x-[30%] translate-y-[20%] rounded-full bg-[rgba(173,109,244,0.5)] dark:bg-purple-900/50 opacity-50 blur-[80px]"></div></div>
      ...
      <div className="container relative mx-auto px-6 lg:px-12">
        <div className="mb-16 relative">
          <div className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-4 opacity-0 animate-fade-in">— TARGET AUDIENCE</div>
          ...
          {audiences.map((audience, index) => (
            ...
            >
              ...
              <div className="relative p-8">
                ...
                <div className="mb-6 p-3 rounded-xl bg-gradient-to-br from-[#e9e0ea] to-white dark:from-gray-700 dark:to-gray-600 inline-block transform transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
                  <audience.icon className="w-8 h-8 text-gray-900 dark:text-white" />
                </div>
