          ...
          {articles.map((article, index) => (
            ...
            >
              <div className="p-6">
                ...
                <div className="mt-4 flex items-center text-purple-600 font-medium text-sm group-hover:text-purple-700 transition-colors duration-300">
                  Read Article
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-purple-600 hover:text-purple-700 font-medium underline decoration-2 decoration-purple-200 hover:decoration-purple-300 transition-all duration-300"
            >
              Affan Shaikhsurab
            </a>
          </p>
