      ...
      <div className="container relative mx-auto px-6 lg:px-12">
        ...
        <div className="mb-12 text-left">
          <div className="inline-block">
            <div className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-4">— WHY CHOOSE US</div>
        ...
        <div class="absolute top-0 -z-10 h-full w-full bg-white dark:bg-black"><div class="absolute bottom-auto left-auto right-0 top-0 h-[500px] w-[500px] -translate-x-[30%] translate-y-[20%] rounded-full bg-[rgba(173,109,244,0.5)] dark:bg-purple-900/50 opacity-50 blur-[80px]"></div></div>
          {features.map((feature, index) => (
            <div
              key={index}
              className="group relative p-8 rounded-xl backdrop-blur-sm bg-white/40 border border-white/60 hover:bg-white/60 dark:bg-gray-800/40 dark:border-gray-700/60 dark:hover:bg-gray-800/60 transition-all duration-300"
            >
